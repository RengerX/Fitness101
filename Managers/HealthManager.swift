...
class HealthManager {
    ...
    func generateActivitiesFromDuration(running: Int, strengt: Int, soccer:Int, basketball:Int, stair:Int, kickboxing:Int) -> [Activity] {
        return [
           Activity( title: "Runnig", subtitle: "This week", image: "figure.run", tinColor: .green, amount: "\(running) mins"),
           Activity( title: "Strength Training", subtitle: "This week", image: "dumbbell", tinColor: .blue, amount: "\(strengt) mins"),
           Activity( title: "Soccer", subtitle: "This week", image: "figure.soccer", tinColor: .indigo, amount: "\(soccer) mins"),
           Activity( title: "Basketball", subtitle: "This week", image: "figure.basketball", tinColor: .green, amount: "\(basketball) mins"),
           Activity( title: "stair", subtitle: "This week", image: "figure.stair.stepper", tinColor: .green, amount: "\(stair) mins"),
           Activity( title: "kickboxing", subtitle: "This week", image: "figure.kickboxing", tinColor: .green, amount: "\(kickboxing) mins"),
        ]
    }
    //MArk: Recents Workouts
    
    func fetchWorkoutsForMouth(month: Date,completion:@escaping (Result<[Workout], Error>) -> Void)  {
        let workouts = HKSampleType.workoutType()
